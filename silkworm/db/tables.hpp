...
inline constexpr MapConfig kConsensusParameters{kConsensusParametersName};
...
inline constexpr MapConfig kExtraBlockData{kExtraBlockDataName};

inline constexpr const char* kRuntimeStatesName{"RuntimeStates"};
inline constexpr MapConfig kRuntimeStates{kRuntimeStatesName};
