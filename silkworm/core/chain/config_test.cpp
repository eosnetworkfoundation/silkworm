...
TEST_CASE("Config revision") {
    ...
    CHECK(kMainnetConfig.revision(build_header(0, 0)) == EVMC_FRONTIER);
    CHECK(kMainnetConfig.revision(build_header(1, 1438269988)) == EVMC_FRONTIER);
    CHECK(kMainnetConfig.revision(build_header(200'000, 1441661589)) == EVMC_FRONTIER);
    CHECK(kMainnetConfig.revision(build_header(1'000'000, 1455404053)) == EVMC_FRONTIER);
    ...
    CHECK(kMainnetConfig.revision(build_header(2'463'001, 1476796812)) == EVMC_TANGERINE_WHISTLE);
    CHECK(kMainnetConfig.revision(build_header(2'674'999, 1479831337)) == EVMC_TANGERINE_WHISTLE);
    CHECK(kMainnetConfig.revision(build_header(2'675'000, 1479831344)) == EVMC_SPURIOUS_DRAGON);
    CHECK(kMainnetConfig.revision(build_header(2'675'001, 1479831347)) == EVMC_SPURIOUS_DRAGON);
    CHECK(kMainnetConfig.revision(build_header(3'000'000, 1484475035)) == EVMC_SPURIOUS_DRAGON);
    CHECK(kMainnetConfig.revision(build_header(4'000'000, 1499633567)) == EVMC_SPURIOUS_DRAGON);
    CHECK(kMainnetConfig.revision(build_header(4'369'999, 1508131303)) == EVMC_SPURIOUS_DRAGON);
    CHECK(kMainnetConfig.revision(build_header(4'370'000, 1508131331)) == EVMC_BYZANTIUM);
    CHECK(kMainnetConfig.revision(build_header(4'370'001, 1508131362)) == EVMC_BYZANTIUM);
    CHECK(kMainnetConfig.revision(build_header(5'000'000, 1517319693)) == EVMC_BYZANTIUM);
    CHECK(kMainnetConfig.revision(build_header(6'000'000, 1532118564)) == EVMC_BYZANTIUM);
    CHECK(kMainnetConfig.revision(build_header(7'000'000, 1546466952)) == EVMC_BYZANTIUM);
    CHECK(kMainnetConfig.revision(build_header(7'279'999, 1551383501)) == EVMC_BYZANTIUM);
    CHECK(kMainnetConfig.revision(build_header(7'280'000, 1551383524)) == EVMC_PETERSBURG);
    CHECK(kMainnetConfig.revision(build_header(7'280'001, 1551383544)) == EVMC_PETERSBURG);
    CHECK(kMainnetConfig.revision(build_header(8'000'000, 1561100149)) == EVMC_PETERSBURG);
    CHECK(kMainnetConfig.revision(build_header(9'000'000, 1574706444)) == EVMC_PETERSBURG);
    ...
    CHECK(kMainnetConfig.revision(build_header(12'243'999, 1618481214)) == EVMC_ISTANBUL);
    CHECK(kMainnetConfig.revision(build_header(12'244'000, 1618481223)) == EVMC_BERLIN);
    CHECK(kMainnetConfig.revision(build_header(12'244'001, 1618481230)) == EVMC_BERLIN);
    CHECK(kMainnetConfig.revision(build_header(12'964'999, 1628166812)) == EVMC_BERLIN);
