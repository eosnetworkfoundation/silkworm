...
TEST_CASE("Recover special signature (type1)") {
    ...
    txn.value = 31337;
    txn.odd_y_parity = false;
    txn.r = intx::from_string<intx::uint256>("0x00"); //r
    txn.s = intx::from_string<intx::uint256>("0xcab1900000000000"); //s  "test"

    CHECK(txn.sender() == make_reserved_address(0xcab1900000000000));
}
...
TEST_CASE("Recover special signature (type2)") {
    ...
    txn.odd_y_parity = true;
    txn.r = intx::from_string<intx::uint256>("0x00"); //r
    txn.s = intx::from_string<intx::uint256>("0xffffffffffffffffffffffff5df9b87991262f6ba471f09758cde1c0fc1de734"); //s

    CHECK(txn.sender() == 0x5df9b87991262f6ba471f09758cde1c0fc1de734_address);
}
