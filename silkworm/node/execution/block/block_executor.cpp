...
BlockExecutor::BlockExecutor(const ChainConfig* chain_config, bool write_receipts, bool write_call_traces, bool write_change_sets, const evmone::gas_parameters& gas_params, const evmone::eosevm::gas_prices& gas_prices)
    : chain_config_{chain_config},
      ...
      gas_prices_{gas_prices} {}

ValidationResult BlockExecutor::execute_single(const Block& block, db::Buffer& state_buffer, AnalysisCache& analysis_cache) {
    ExecutionProcessor processor{block, *protocol_rule_set_, state_buffer, *chain_config_, true, gas_params_, gas_prices_};
